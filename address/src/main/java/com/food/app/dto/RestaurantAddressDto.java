...
@Data
@Schema(name = "Restaurant_Address", description = "This Schema Holds Restaurant Address Information")
public class RestaurantAddressDto {
    ...
    @Schema(description = "Restaurant Id For Address", example = "122bdshbddsajdxbnsaj121212")
    @NotEmpty(groups = {Default.class, Create.class, Update.class}, message = "Restaurant Id is must be require !")
